...
//	WebDriver driver;
	...
	@Before public void setUp() {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\DSAHEENA\\Desktop\\API testing\\REST Assured\\countryside\\drivers\\chromedriver.exe");
	...
	public void user_enters_the_vaild_email_id_and_password() throws InterruptedException {
		driver.findElement(By.id("login-email-id")).sendKeys("Shaahi4mail@gmail.com");
